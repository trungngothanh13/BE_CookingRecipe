...
INSERT INTO Course (CourseTitle, Description, ThumbNail, Price, Difficulty, Duration, ModuleCount, Category, ViewCount, PurchaseCount, AverageRating) VALUES
('Italian Pasta Fundamentals', 'Learn the art of making perfect pasta from scratch. This beginner-friendly course covers pasta basics, sauce pairing, and classic Italian recipes.', 'https://example.com/pasta-thumb.jpg', 49.99, 'Beginner', 180, 3, 'Italian', 523, 42, 4.5),
('Thai Street Food Mastery', 'Master authentic Thai cooking techniques and create restaurant-quality dishes at home. Includes knife skills, traditional ingredients, and signature recipes.', 'https://example.com/thai-thumb.jpg', 59.99, 'Intermediate', 240, 3, 'Thai', 287, 18, 4.8);
